                    ...
                    {courses.map((course) => (
                        ...
                        >
                            ...
                            <div className="mt-5 flex items-center gap-3 border-t border-amber-100 pt-4">
                                ...
                                <Link href={user ? `/student/courses/${course.id}` : `/auth/register?course=${course.id}`} className="rounded-full bg-[#0047AB] px-4 py-2 font-semibold text-white transition hover:bg-[#001F5B]">Enrol</Link>
